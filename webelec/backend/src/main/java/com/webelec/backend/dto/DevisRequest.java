...
public class DevisRequest {
    ...
    @NotEmpty(message = "Les lignes de devis sont obligatoires")
    @Valid
    ...
    public List<DevisLigneRequest> getLignes() {
        return lignes;
    }

    public void setLignes(List<DevisLigneRequest> lignes) {
        this.lignes = lignes;
    }
    ...
    public Devis toEntity() {
        ...
        List<DevisLigne> mapped = lignes.stream()
                .map(DevisLigneRequest::toEntity)
        ...
        Devis devis = Devis.builder()
                ...
                .client(client)
                .build();
        mapped.forEach(l -> l.setDevis(devis));
        devis.setLignes(mapped);
        return devis;
    }
}
