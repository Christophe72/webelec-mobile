...
import com.webelec.navigation.domain.NavigationRole;
...
class NavigationServiceTest {
    ...
    when(navigationRolePermissionRepository.findByRoleCode("TECHNICIEN"))
        .thenReturn(List.of());
    ...
    when(navigationRolePermissionRepository.findByRoleCode("GERANT"))
        .thenReturn(List.of(
    ...
    when(navigationRolePermissionRepository.findByRoleCode("ADMIN"))
        .thenReturn(List.of(rolePermission("ADMIN", p1), rolePermission("ADMIN", p2)));
    ...
    when(navigationRolePermissionRepository.findByRoleCode("GERANT"))
        .thenReturn(List.of(rolePermission("GERANT", p)));
